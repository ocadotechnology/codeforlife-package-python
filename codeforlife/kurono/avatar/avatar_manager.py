...
from ..worksheet.worksheet import WorksheetData, get_worksheet_data
...
class AvatarManager(object):
    ...
    def add_avatar(self, player_id, location):
        avatar = AvatarWrapper(player_id, location, AvatarAppearance("#000", "#ddd", "#777", "#fff"))
    ...
    def serialize_players(self):
        ...
        return [self.worksheet.avatar_state_serializer(avatar) for avatar in self.avatars]
