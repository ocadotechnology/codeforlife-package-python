# Generated by Django 3.2.20 on 2023-12-07 11:14

import codeforlife.user.models.school_teacher_invitation
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_saved_at', models.DateTimeField(auto_now=True, help_text='Record the last time the model was saved. This is used by our data warehouse to know what data was modified since the last scheduled data transfer from the database to the data warehouse.', verbose_name='last saved at')),
                ('delete_after', models.DateTimeField(blank=True, help_text="When this data is scheduled for deletion. Set to null if not scheduled for deletion. This is used by our data warehouse to transfer data that's been scheduled for deletion before it's actually deleted. Data will actually be deleted in a CRON job after this point in time.", null=True, verbose_name='delete after')),
                ('second_password', models.CharField(editable=False, help_text='A unique key that allows a student to log directly into theiraccount.', max_length=64, validators=[django.core.validators.MinLengthValidator(64)], verbose_name='secondary password')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_saved_at', models.DateTimeField(auto_now=True, help_text='Record the last time the model was saved. This is used by our data warehouse to know what data was modified since the last scheduled data transfer from the database to the data warehouse.', verbose_name='last saved at')),
                ('delete_after', models.DateTimeField(blank=True, help_text="When this data is scheduled for deletion. Set to null if not scheduled for deletion. This is used by our data warehouse to transfer data that's been scheduled for deletion before it's actually deleted. Data will actually be deleted in a CRON job after this point in time.", null=True, verbose_name='delete after')),
                ('expires_at', models.DateTimeField(default=codeforlife.user.models.school_teacher_invitation._set_expires_at, help_text='When the teacher was invited to the school.', verbose_name='is expired')),
        ...
        migrations.AddField(
            model_name='classstudentjoinrequest',
            name='klass',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_join_requests', to='user.class'),
        ),
        migrations.AddField(
            model_name='classstudentjoinrequest',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_join_requests', to='user.student'),
        ),
        migrations.AddField(
            model_name='class',
            name='school',
        ...
        migrations.AddConstraint(
            model_name='student',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('klass__isnull', True), ('school__isnull', True)), models.Q(('klass__isnull', False), ('school__isnull', False)), _connector='OR'), name='student__school_is_null_and_class_is_null'),
        ),
        ...
        migrations.AddConstraint(
            model_name='user',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('student__isnull', False), ('teacher__isnull', True)), models.Q(('student__isnull', True), ('teacher__isnull', False)), _connector='OR'), name='user__teacher_is_null_or_student_is_null'),
        ),
    ]
