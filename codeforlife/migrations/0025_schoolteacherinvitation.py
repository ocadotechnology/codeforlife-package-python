    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_teacher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='school_invitations', to='codeforlife.teacher')),
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teacher_invitations', to='codeforlife.school')),
            ],
        ),
    ]
